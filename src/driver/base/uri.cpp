...
std::string uri::auth_source() const { return mongoc_uri_get_auth_source(_impl->uri_t); }
...
std::string uri::password() const { return mongoc_uri_get_password(_impl->uri_t); }
...
std::string uri::username() const { return mongoc_uri_get_username(_impl->uri_t); }
