...
void bulk_write::append(const model::write& operation) {
    switch (operation.type()) {
        ...
        case model::write::type::k_update_many: {
        ...
        case model::write::type::k_uninitialized:
