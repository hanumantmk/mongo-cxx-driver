...
void count::limit(std::int32_t limit) {
    _limit = limit;
}
...
void count::skip(std::int32_t skip) {
    _skip = skip;
}
...
const optional<std::int32_t>& count::limit() const {
    return _limit;
}
...
const optional<std::int32_t>& count::skip() const {
    return _skip;
}

const optional<class read_preference>& count::read_preference() const {
